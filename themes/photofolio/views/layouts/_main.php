...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Ciudad', 'url'=>array('/ciudad/index', 'view'=>'about')),
				...
				array('label'=>'Vacantes', 'url'=>array('/Vac/index')),
			),
		)); ?>
	</div><!-- mainmenu -->
	...
	if($flashMessages){
		...
		echo '<li><div class="flash-'.$key.'error">'.$message."</div></li>\n";
		}
		echo '</ul>';
	}
	?>
...
'myHideEffect',
'$(".info").animate({opacity:1.0},10000000).slideUp("slow");',
