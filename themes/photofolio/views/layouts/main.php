...
<div class="wrapper col1">
  <div id="header" class="clear">
    <div class="fl_left">
     ...
     <div class="fl_right"><a href="#"><?php echo CHtml::image(Yii::app()->theme->baseUrl."/images/demo/468x60.gif","468x60");?></a>
	  	<div style="text-align:right">
    <?php
	$color=array('style'=>'color:#fff');
	echo CHtml::link('Español',$this->createUrl('',array('lg'=>'es')),$color).'|'.CHtml::link('English',$this->createUrl('',array('lg'=>'en')),$color);
	?>
	</div>
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
				...
				array('label'=>'Usuarios', 'url'=>array('/usuario/index'),
						'items'=>array(
							array('label'=>'Nuevo', 'url'=>array('/usuario/create')),
							array('label'=>'Listado usarios', 'url'=>array('/usuario/index')),
