...
/**
 * This is the model class for table "t10_conocimientos".
 *
 * The followings are the available columns in table 't10_conocimientos':
 * @property integer $id
 ...
 */
class T10Conocimientos extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, descripcion, M04_Pasantia_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return T10Conocimientos the static model class
	 */
