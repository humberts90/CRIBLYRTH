...
/**
 * This is the model class for table "t06_observacion".
 *
 * The followings are the available columns in table 't06_observacion':
 * @property integer $id
 ...
 */
class T06Observacion extends CActiveRecord
{
	/**
	 ...
	 * @return T06Observacion the static model class
	 */
