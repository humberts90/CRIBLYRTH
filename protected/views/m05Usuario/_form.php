...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->passwordField($model,'Clave',array('size'=>45,'maxlength'=>45, 'class'=>"form-control")); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'Correo_Electronico',array('size'=>60,'maxlength'=>255, 'class'=>"form-control")); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'Unidades_Credito_Aprobadas', array('rows'=>6, 'cols'=>50, 'class'=>"form-control")); ?>
		<?php echo $form->error($model,'Unidades_Credito_Aprobadas'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'Servicio_Comunitario'); ?>
		<?php echo $form->textField($model,'Servicio_Comunitario', array('rows'=>6, 'cols'=>50, 'class'=>"form-control")); ?>
		<?php echo $form->error($model,'Servicio_Comunitario'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'Ultimo_Lapso_Academico'); ?>
		<?php echo $form->textField($model,'Ultimo_Lapso_Academico',array('size'=>6,'maxlength'=>6, 'class'=>"form-control")); ?>
