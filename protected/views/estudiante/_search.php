...
?>
	...
	<div class="row">
		...
		<?php echo $form->error($model_1,'Telefono_2'); ?>
	</div>
	...
	<div class="row">
		...
		<div class="row">
			<?php echo $form->dropDownList($model_1,'P06_id',CHtml::listData(P06Estado::model()->findAll(),'id','Descripcion'),array('empty'=>'Seleccione Parroquia','class'=>'form-control')); ?>
			<?php echo $form->error($model_1,'P06_id'); ?>
			<?php echo $form->error($model_1,'P06_id'); ?>
	</div>

	<div class="row">
			<?php echo $form->dropDownList($model_1,'P07_id',CHtml::listData(P07Pais::model()->findAll(),'id','Descripcion'),array('empty'=>'Seleccione Parroquia','class'=>'form-control')); ?>
