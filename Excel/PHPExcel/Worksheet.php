...
include 'Cell/DataType.php';
include 'CachedObjectStorageFactory.php';
include 'Worksheet/PageSetup.php';
include 'Worksheet/PageMargins.php';
include 'Worksheet/HeaderFooter.php';
include 'Worksheet/SheetView.php';
include 'Worksheet/Protection.php';
include 'Worksheet/RowDimension.php';
include 'Worksheet/ColumnDimension.php';
include 'Worksheet/AutoFilter.php';
