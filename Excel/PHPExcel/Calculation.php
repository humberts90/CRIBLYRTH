...
include 'Calculation/Function.php';
include 'Calculation/Functions.php';
include 'Calculation/MathTrig.php';
include 'Calculation/Token/Stack.php';
include 'Calculation/Statistical.php';
